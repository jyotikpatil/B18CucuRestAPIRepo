...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data(String username) throws IOException{
		...
		//Read data from file
		String data = ""; 
	    data = new String(Files.readAllBytes(Paths.get("C:\\Users\\swami\\workspace\\B18CucuRestAssured\\src\\test\\java\\com\\basic\\postUpdatedJsonSD\\user.json"))); 
	  ...
	  //get timeStamp 
	  		String myTimeStamp = new SimpleDateFormat("yyyyMMdd-HHmmss")
	  				.format(Calendar.getInstance().getTime());
	  		System.out.println(myTimeStamp);
	  		
	    System.out.println("json in String ==== " +newJsonStr+myTimeStamp);
